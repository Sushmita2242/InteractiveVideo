...
export declare class ValidatorBuilder {
     ...
     * @returns
     */
    addRule(rule: (content: any, error: AggregateH5pError) => any): ValidatorBuilder;
    /**
     ...
     * @returns
     */
    addRuleWhen(rule: (content: any, error: AggregateH5pError) => any, condition: boolean): ValidatorBuilder;
    /**
     ...
     */
    validate(data: any, error?: AggregateH5pError): Promise<any>;
}
/**
 ...
 */
export declare function throwErrorsNowRule(data: any, error: AggregateH5pError): any;
