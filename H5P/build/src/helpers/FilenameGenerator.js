...
var nanoid = nanoid_1.customAlphabet(idCharacters, 8);
var idRegex = new RegExp("^[" + idCharacters + "]+$");
/**
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                filenameAttempt = "" + (dirname ? dirname + "/" : '') + upath_1["default"].basename(actualFilename, upath_1["default"].extname(actualFilename)) + "-" + nanoid() + upath_1["default"].extname(actualFilename);
