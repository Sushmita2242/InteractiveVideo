 ...
 */
var catchAndPassOnErrors = function (fn, handleErrors) { return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    statusText = '';
                    clientErrorId = '';
                    if (!(err instanceof H5pError_1["default"])) return [3 /*break*/, 3];
                    if (!(req.t &&
                        req.i18n &&
                        languageOverride &&
                ...
                case 2:
                    ...
                    if (err instanceof AggregateH5pError_1["default"]) {
                        detailsList = err.getErrors().map(function (e) {
                            return {
                                code: e.errorId,
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4:
                    res.status(statusCode).json(new AjaxErrorResponse_1["default"](clientErrorId, statusCode, statusText, detailsList));
                    return [2 /*return*/];
            }
        });
    }); };
