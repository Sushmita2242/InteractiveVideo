...
export default class H5PEditor {
     ...
     * for more details.
     */
    constructor(cache: IKeyValueStorage, config: IH5PConfig, libraryStorage: ILibraryStorage, contentStorage: IContentStorage, temporaryStorage: ITemporaryFileStorage, translationCallback?: ITranslationFunction, urlGenerator?: IUrlGenerator);
     ...
     */
    getContentTypeCache(user: IUser): Promise<IHubInfo>;
    /**
     ...
     */
    getLibraryFileStream(library: ILibraryName, filename: string): Promise<ReadStream>;
    /**
     * Gets a rough overview of information about the requested libraries.
     * @param ubernames
     */
    getLibraryOverview(ubernames: string[]): Promise<ILibraryOverviewForClient[]>;
    /**
     ...
     */
    render(contentId: ContentId, language?: string): Promise<string | any>;
    /**
     ...
     * to true.
     */
    uploadPackage(data: Buffer, user?: IUser, options?: {
