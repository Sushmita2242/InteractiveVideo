...
export interface ILibraryStorage {
     ...
     */
    addFile(library: ILibraryName, filename: string, readStream: Stream): Promise<boolean>;
    /**
     ...
     */
    getInstalledLibraryNames(...machineNames: string[]): Promise<ILibraryName[]>;
    /**
 ...
 */
export declare type ITranslationFunction = (key: string, language: string) => string;
